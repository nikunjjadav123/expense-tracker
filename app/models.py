...
class ExpenseCreate(BaseModel):
    ...
    category: Optional[str] = Field(None, max_length=50, description="Category of the expense")
    date: datetime = Field(default_factory=datetime.utcnow, description="Date of the expense")
    notes: Optional[str] = Field(None, max_length=500, description="Additional notes about the expense")
